# calendar-mirror Specification

## Purpose
Espejo opcional de recordatorios como eventos en Google Calendar, con autenticación OAuth permanente y fallas nunca bloqueantes para el recordatorio.
